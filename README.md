...
A tiny version of Nuru Programming Language with no dependencies.
...
```
curl -O -L https://github.com/NuruProgramming/KaNuru/releases/download/v0.5.18/nuru_Linux_amd64.tar.gz
```
...
- Download the binary:
  ...
  - For apple silicon mac use:
    ...
    ```
    curl -O -L https://github.com/NuruProgramming/KaNuru/releases/download/v0.5.18/nuru_Darwin_arm64.tar.gz
    ```

  - For apple intel mac use:

    ```
    curl -O -L https://github.com/NuruProgramming/KaNuru/releases/download/v0.5.18/nuru_Darwin_amd64.tar.gz
    ```
...
3. **Download the Nuru package**:
   ...
   ```bash
   curl -O -L https://github.com/NuruProgramming/KaNuru/releases/download/v0.5.18/nuru_Android_arm64.tar.gz
   ```
...
- Executable:
  ...
  - Download the Nuru zip file [Here](https://github.com/NuruProgramming/KaNuru/releases/download/v0.5.18/nuru_Windows_amd64.zip)
...
- Make sure you have golang installed (atleast 1.25 and above)
